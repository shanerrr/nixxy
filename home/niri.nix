...

{
  ...
  programs.niri.settings = {
    ...
    binds = with config.lib.niri.actions; {
      ...
      # --- Close window (you mapped this to W) ---
      ...
      # --- Workspaces: focus / move (directional) ---
      ...
      # --- Mouse wheel over the workspaces / columns ---
      ...
      # --- Workspaces by index: focus (helper) ---
      ...
      # --- Workspaces by index: move column (direct form, issue #944) ---
      ...
      # --- Power off monitors ---
      "Mod+Shift+0".action = power-off-monitors;
    };
  };
}
